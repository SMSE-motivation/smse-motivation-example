...
DRIVE="-drive file=$ENV_DIR/images/debian-9.2.1-x86_64/image.raw.s2e,format=s2e,cache=writeback"
...
LIBS2E="$BUILD_DIR/libs2e-$BUILD/x86_64-s2e-softmmu/libs2e.so"
